  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 lg:p-8">
      <div className="max-w-6xl mx-auto">
                    ...
                    <div className="flex-1 bg-green-50/70 rounded-xl p-5 transition-all duration-300 min-h-[450px] flex flex-col border-2 border-green-400 shadow-[0_0_20px_rgba(34,197,94,0.4)] hover:shadow-[0_0_30px_rgba(34,197,94,0.6)]">
                      ...
                      <div className="flex-1 space-y-2 text-sm">
                        <div className="flex justify-between border-b border-gray-100 pb-1">
                          <span className="text-gray-500 max-w-[60%]">Lower Heating Value</span>
                          <span className="font-medium text-gray-700 text-right">50 MJ/kg</span>
                        </div>
                        <div className="flex justify-between border-b border-gray-100 pb-1">
                          <span className="text-gray-500 max-w-[60%]">Volumetric Energy Density</span>
                          <span className="font-medium text-gray-700 text-right">36 MJ/m³</span>
                        </div>
                        <div className="flex justify-between border-b border-gray-100 pb-1">
                          <span className="text-gray-500 max-w-[60%]">Density (STP)</span>
                          <span className="font-medium text-gray-700 text-right">0.72 kg/m³</span>
                        </div>
                        <div className="flex justify-between border-b border-gray-100 pb-1">
                          <span className="text-gray-500 max-w-[60%]">Flammability Range</span>
                          <span className="font-medium text-gray-700 text-right">5–15%</span>
                        </div>
                        <div className="flex justify-between border-b border-gray-100 pb-1">
                          <span className="text-gray-500 max-w-[60%]">Flame Speed</span>
                          <span className="font-medium text-gray-700 text-right">0.4 m/s</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-500 max-w-[60%]">Boiling Point</span>
              ...
              <div className="flex flex-col items-center gap-3 mt-2">
                <div className="w-full max-w-md">
                  <button
                    ...
                    className="w-full flex items-center justify-between gap-2 px-4 py-2 bg-hydrogen-100 hover:bg-hydrogen-200 text-hydrogen-700 rounded-lg font-medium text-sm transition-all duration-200"
              ...
              <div className="mt-8">
                ...
                <div className="grid grid-cols-3 gap-4 max-w-3xl mx-auto">
                  {[
                    ...
                    <button
                      key={item.id}
                      className="aspect-square p-4 bg-red-500 hover:bg-red-600 rounded-lg shadow-md hover:shadow-lg transition-all text-white font-medium text-center flex items-center justify-center"
        ...
        {/* Transport Section - Common Causes of Pipeline Leaks */}
        {isDetailView && selectedQuadrant === "transport" && (
          <div className="mb-8 animate-slide-up">
            <div className="border-b border-gray-200 pb-4 mb-6">
              <h3 className="text-2xl font-bold text-gray-800 mb-2">
