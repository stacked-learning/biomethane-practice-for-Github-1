...
const safetyCards: SafetyCard[] = [
  ...
  },
  {
    ...
    description: "Methane cannot be detected visually at normal pressures and temperatures, which means leaks may go unnoticed without dedicated gas detection systems in place."
  },
  {
